...
<body>
  ...
  <div>
    <div class="container-lg">
      ...
      <div class="card-deck">
        <div class="card">
          <img class="card-img-top" src="immagini/mele_prova_carousel.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Frutta</h5>
            <p class="card-text">Non penso sia necessario spiegare cos'è la frutta</p>
            <a href="categoria.html" class="btn btn-primary">Vai ai prodotti</a>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="immagini/miele_prova_carousel.jpg" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card">
          <img class="card-img-top" src="immagini/pomodori_prova_carousel.jpg" alt="Card image cap">
          <div class="card-body">
