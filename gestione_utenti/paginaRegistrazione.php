...
<article class="card-body mx-auto" style="max-width: 400px;">
  ...
  <script>
	...
	<form action="/gestione_utenti/registrazione.php" method="POST" name="registr" onSubmit="return validaForm();">
    ...
    <p class="text-center">Hai già un account? <a href="/gestione_utenti/paginaLogin.php">Login</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
