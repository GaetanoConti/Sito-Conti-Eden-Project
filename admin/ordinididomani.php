...
or die('Could not connect: ' . pg_last_error());
    ...
    $query="select ord.id, acc.nome, acc.cognome, ord.telefono, ord.giorno, ord.fasciaoraria, ord.prezzofinale from ordini ord,accounts acc where ord.giorno = current_date + interval '1 day' and ord.cliente = acc.email order by ord.giorno, ord.fasciaoraria DESC;"; 
    $res = pg_exec($query);
