...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-success" style="max-height: 80px; border-radius: 0%">
    ...
    <img src="immagini/logobianco.png"  width="50" height="50" style="margin-left:-10%; margin-top: -1% " >
      ...
      style="margin-left: 10%">
        <a class="navbar-brand" href="paginaLogin.php" style="color:white; margin-top: 2%; margin-left: -10%; font-size: 20px">
          Carrello
        </a>
      </nav>
      <nav class="navbar navbar-light bg-success">
      <img src="immagini/azienda.png" alt="azienda" width="30" height="30" class="d-inline-block align-top" style="margin-left: 10%">
        ...
        <nav class="navbar navbar-light bg-success">
        <img src="immagini/account2.png" alt="account" width="30" height="30" class="d-inline-block align-top" style="margin-left: 2%">
            <a class="navbar-brand" href="profilo.php" style="color:white;  margin-top: 1%; margin-left: -4%; margin-right: -4% ; font-size: 20px">
        ...
        <button type="submit" name="submit_param" value="submit_value" class="navbar-brand" style="color:white;height:25px;width:75px; margin-top: -2%; margin-left: -22%; font-size: 20px">
          Logout
        </button>  
        </form>
        </nav>
